...
backgrounds = [
    "Was found as a baby in the forest, raised by wild wolves",
    "Grew up in a circus, can juggle and read minds",
    "Escaped slavery after killing his cruel master",
    "Lost his entire family in a fire, seeks revenge on the arsonists",
    "Served as a royal spy but betrayed the crown for love",
    "Was cursed by a witch in childhood — turns into a beast during the full moon",
    "Found an ancient artifact that gives power but slowly kills him",
    "Was resurrected from the dead by a necromancer, remembers only his name",
    "Was born with silver eyes — everyone fears him as a harbinger of doom",
    "Has lived in a cemetery since childhood, talks to ghosts",
    "Was a knight but lost his honor due to false accusation",
    "Ran away from the mage's house because he couldn't endure the brutal training",
    "Found a talking raven who became his only friend",
    "Was a changeling with fairies, returned to the human world after 100 years",
    "Sold his soul to a demon to save a loved one",
    "Was born on the day of a solar eclipse — is considered the chosen one",
    "Has hidden all his life that he is half dragon",
    "Lost his memory after being struck by lightning, started seeing the dead",
    "Was a pirate captain, but the crew mutinied and marooned him on an island",
    "Made a deal with a witch — forgot his past in exchange for magic"
]
...
legs_wear = ["Leather pants", "Torn wool breeches", "Kilt", "Heavy plate legguards", "Long fur skirt", "Linen loose harem pants", "Black tight leggings", "Rag loincloth", "No pants", "Leather skirt with fringe", "Metal-plated greaves", "Fur pants", "Long dress", "Silk pants", "Torn riding breeches"]
...
label = Label(root, text='Choose your character\'s gender')
label.pack()
...
Button(root, text="Generate name", bg='#58fc87', activebackground='#48c76f', command=generate).pack()
...
Button(root, text="Generate backstory", bg='#58fc87', activebackground='#48c76f', command=back).pack()
...
Button(root, text="Generate outfit", bg='#58fc87', activebackground='#48c76f', command=tip4).pack()
